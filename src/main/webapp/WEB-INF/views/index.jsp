											...
											<div class="row">
												<div class="price col-sm-6">
													<h5 style="margin-bottom: 7px;">
														<c:out value="${status.index+1}" /> 위 :
														<c:out value="${store.store_name}" /> 샵
													</h5>
											...
											<div class="separator clear-left">
												...
												<p class="btn-details">
													<button class="btn btn-info store_review" style="width: 90%;" value="${store.store_pk}">
														...
														리뷰&nbsp;&nbsp;<c:out value="${store.store_review_count}" />	개
													</button>
												</p>
											</div>
			...
			<div id="select-nail-bar" class="w3-bar" style="text-align: center;">
				...
				<div class="w3-dropdown-hover">
					<div id="main-nail-color" class="w3-border w3-hover-border-pale-red  w3-round" style="padding-left: 10px;" value="전체">
						<img src="${path }/resources/images/indexImg/all-color.jpg" class="w3-circle" alt="Cinque Terre" width="20" height="20">
					...
					<div class="cover-card col-sm-${col_i[status.index]} more-list"
						...
						<div class="hovereffect">
							...
							<div class="overlay">
								...
								<br>
								<br> 
								<a href="${path}/store/store.do?store_pk=${nail.store_pk}">점포로 	이동</a>
								<!-- 점포 쿼리스트링으로 pk쏴서 이동. -->
								</p>
							</div>
						</div>

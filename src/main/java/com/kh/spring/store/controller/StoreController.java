...
public class StoreController {
	...
	public String storeMap(HttpServletRequest req, Model model) {
	...
	public String storeReserve(HttpServletRequest req, Model model) {
	...
	public String storeContact(HttpServletRequest req, Model model) {

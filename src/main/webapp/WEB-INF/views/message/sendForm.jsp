...
<section style="padding-top: 100px;">
	<div class='container'>
		...
		<div class="container">
			<div class="panel">
				<form class="form-horizontal" action="${path}/message/sendMessageEnd.do?member_pk=${memberLoggedIn.memberPk}" method="post">
					<div class="form-group">
						<label class="col-sm-3 control-label" for="">보내는사람 </label>
						<div class="col-sm-6">
							<input class="form-control" type="text" id="send_user" name="send_user" placeholder="아이디" value="${memberLoggedIn.memberId}" readonly>
						</div>
					</div>

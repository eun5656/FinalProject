...
public class StoreManageController {
	...
	public String store(HttpServletRequest req, Model model, HttpSession session) {
	...
	public String storeManageSale(HttpServletRequest req, Model model, HttpSession session) {
	...
	public String storeManageSale(String store_pk, HttpServletRequest req, Model model, HttpSession session,
	...
	@ResponseBody
	public String menuDelete(HttpServletRequest req, @RequestParam String menu_pk) throws JsonProcessingException {
	...
	@ResponseBody
	public String menuUpdate(HttpServletRequest req, Menu menu) throws JsonProcessingException {
	...
	public String nailInsert(Nail nail, @RequestParam("input-file-preview") MultipartFile img, HttpSession session,
			Model model) {
	...
	@RequestMapping(value = "/store/storeManage/nailUpdate.do", method = RequestMethod.POST, consumes = {
			"multipart/form-data" }, produces = { "application/text; charset=utf8" })
	public String nailUpdate(Nail nail, @RequestParam("input-file-preview") MultipartFile img, HttpSession session,
			Model model, @RequestParam("oldImage") String oldImage) {
		System.out.println(nail);
		System.out.println(img);
		String renamedFileName = null;
		String originalFileName = null;
	...
	@ResponseBody
	public String nailDelete(HttpServletRequest req, @RequestParam String nail_pk) throws JsonProcessingException {
	...
	public String storeUpdate(Model model, Store store, @RequestParam("input-file-preview") MultipartFile img,
			HttpSession session) {
	...
	@ResponseBody
	public String designerDelete(HttpServletRequest req, @RequestParam String designer_pk)
	...
	@ResponseBody
	public String designerUpdate(HttpServletRequest req, designer designer) throws JsonProcessingException {
	...
	public String designerInsert(designer designer, HttpServletRequest req, Model model) {
		...
		if (size == 0) {
			...
			if (designersCheck.get(0).getDesigner_id().equals("a")
					&& designersCheck.get(1).getDesigner_id().equals("b")) {
				designer.setDesigner_id("c");
			} else if (designersCheck.get(0).getDesigner_id().equals("b")
					&& designersCheck.get(1).getDesigner_id().equals("a")) {
				designer.setDesigner_id("c");
			} else if (designersCheck.get(0).getDesigner_id().equals("c")
					&& designersCheck.get(1).getDesigner_id().equals("a")) {
				designer.setDesigner_id("b");
			} else if (designersCheck.get(0).getDesigner_id().equals("a")
					&& designersCheck.get(1).getDesigner_id().equals("c")) {
				designer.setDesigner_id("b");
			} else {
				designer.setDesigner_id("a");
			}
	...
	public String storeManageReserve(HttpServletRequest req, Model model) {
	...
	public String holidayInsert(@RequestParam("holiday") String holiday, @RequestParam("store_pk") int store_pk,
	...
	@ResponseBody
	public String holidayDelete(@RequestParam("holiday") String holidayOld, @RequestParam("store_pk") int store_pk,
			HttpServletRequest req, Model model) throws JsonProcessingException {

		...
		<div class="col-sm-10">
			<div class="panel">
				...
				<div class="panel-body">
					...
					<form id="articleForm" role="form" action="${path}/customer/faqFormEnd.do" method="post">
						<br style="clear: both">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea class="form-control" id="summernote" name="faqContent" maxlength="140" rows="7"></textarea>
							</div>
						</div>
						<div class="form-group">

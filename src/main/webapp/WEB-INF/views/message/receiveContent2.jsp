	...
	<div class='container'>
		<div class='panel'>
			<ul class="nav nav-tabs">
				<li role="presentation"><a href="${path}/message/receiveMessage.do?send_user=${memberLoggedIn.member_id}">보낸쪽지함</a></li>
          		<li class="active" role="presentation"><a href="${path}/message/receiveMessage2.do?receive_user=${memberLoggedIn.member_id}">받은쪽지함</a></li>
        	</ul>
			...
			<div class="row">
				<div class="col-sm-2">
					<button type="button" class="btn btn-default">
						<a href="${path}/message/receiveMessage2.do?receive_user=${memberLoggedIn.member_id}">목록으로</a>
					</button>
				</div>

		...
		<div class="row setup-content" id="step-2">
			<div class="col-xs-12">
				<div class="col-md-12">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label" for="memberPhone">휴대폰</label>
						<div class="col-sm-6">
					...
					<br>
					<button class="btn btn-primary nextBtn btn-lg pull-right" type="submit" onclick="return fn_submit_validate()">회원가입</button>
				</div>
			</div>
		</div>
	</form>

            ...
            $(function() {
                  ...
                  $.ajax({
                     ...
                     success : function(data) {
                        ...
                        for (var i = 0; i < data.list.length; i++) {
                           ...
                           html2 += "<input class='memberPk' name='memberPk' type='hidden' value='${memberLoggedIn.memberPk}' >";
               ...
               $("#reset-all").on("click", function() {
                  ...
                  $.ajax({
                     ...
                     error : function(jpxhr, ㅅextStatus, errormsg) {
                        console.log("ajax전송실패");
                        console.log(jpxhr);
                        console.log(textStatus);
                        console.log(errormsg);
               ...
               $(".b_icon").click(function() {
                  ...
                  if (memberLoggedIn.length != 0) {
                     ...
                     var bookmark_val = {
                           ...
                           memberPk : temp.nextAll("[name='memberPk']").val(),
                     ...
                     if (temp.attr("alt") == 'false') {
                        ...
                        var memberPk = temp.nextAll("[name='memberPk']").val();
                        $.ajax({
         ...
         <div id="nail-list">
            <c:forEach items="${nailist}" var="nail" varStatus="status">
               <div class="cover-card col-sm-${col_i[status.index]}">
                  ...
                  <input class="nail_pk" name="nail_pk" type="hidden" value="${nail.nail_pk}"> <input class="store_pk" name="store_pk" type="hidden" value="${nail.store_pk}">
                  <input class="memberPk" name="memberPk" type="hidden" value="${memberLoggedIn.memberPk}">
                  ...
                  <div class="hovereffect">
                     ...
                     <div class="overlay">
                        ...
                        <br>
                        <br>
                        <br> <a href="${path}/store/store.do?store_pk=${nail.nail_pk}">점포로 이동</a>
                        <!-- 점포 쿼리스트링으로 pk쏴서 이동. -->
                        </p>
                     </div>
                  </div>

...
public Reserve(int reserve_pk, int member_pk, String member_name, int store_pk, String designer_name,
		String designer_id, int menu_pk, String reserve_status, String reserve_start_time, String reserve_end_time,
		String reserve_apply_date, String store_name, String store_phone, String store_re_img, String menu_name,
		String menu_info) {
	super();
...
public String toString() {
	return "Reserve [reserve_pk=" + reserve_pk + ", member_pk=" + member_pk + ", member_name=" + member_name
			...
			+ store_re_img + ", menu_name=" + menu_name + ", menu_info=" + menu_info + "]";
}

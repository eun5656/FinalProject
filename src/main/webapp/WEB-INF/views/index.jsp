								...
								<div class="col-sm-4">
									<div class="col-item">
										<div class="photo store_img" style="cursor: pointer;">
											...
											<img src="${path }/resources/images/nail_store/${store.store_re_img}" class="img-responsive">
										</div>
										<div class="info">
											<div class="row">
												...
												<div class="rating col-sm-6">
													<c:forEach begin="1" end="${store.store_rank}"><i class="price-text-color fa fa-star"></i></c:forEach>
													<c:forEach begin="1" end="${5-store.store_rank}"><i class=" fa fa-star"></i></c:forEach>
												</div>
											</div>
											<div class="separator clear-left">
												<p class="btn-add" style="">
													<button class="btn btn-warning store_reservaiton" style="width: 90%; z-index: 10;" value="${store.store_pk}">
														<span class="glyphicon glyphicon-time"></span>예약하기
													</button>
												</p>
												<p class="btn-details">
													<button class="btn btn-info store_review" style="width: 90%;" value="${store.store_pk}">
														<span class="glyphicon glyphicon-comment"></span>리뷰&nbsp;&nbsp;
														<c:out value="${store.store_review_count}" />개
													</button>
												</p>
											</div>
			...
			<div id="select-nail-bar" class="w3-bar" style="text-align: center;">
				...
				<div class="w3-dropdown-hover">
					<div id="main-nail-color"
						...
						<img src="${path }/resources/images/nails/all-color.jpg" class="w3-circle" width="20" height="20">
						...
						<ul id="dropdown-menu">
							<li class="nail-color" value="레드"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/red.jpg" class="w3-circle" width="30" height="30">
									</div>레드
							</a></li>
							<li class="nail-color" value="핑크"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/pink.png" class="w3-circle" width="30" height="30">
									</div>핑크
							</a></li>
							<li class="nail-color" value="오렌지"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/orange.png" class="w3-circle" width="30" height="30">
									</div>오렌지
							</a></li>
							<li class="nail-color" value="옐로우"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/yellow.jpg" class="w3-circle" width="30" height="30">
									</div>옐로우
							</a></li>
							<li class="nail-color" value="그린"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/green.jpg" class="w3-circle" width="30" height="30">
									</div>그린
							</a></li>
							<li class="nail-color" value="민트"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/mint.jpg" class="w3-circle" width="30" height="30">
									</div>민트
							</a></li>
							<li class="nail-color" value="블루"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/blue.png" class="w3-circle" width="30" height="30">
									</div>블루
							</a></li>
							<li class="nail-color" value="라벤더"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/lavender.png" class="w3-circle" width="30" height="30">
									</div>라벤더
							</a></li>
							<li class="nail-color" value="화이트"><a>
									<div style="text-align: center;">
										<img src="${path }/resources/images/indexImg/white.png" style="border: 1px solid black;" class="w3-circle" width="30" height="30">
									</div>화이트
							</a></li>
							<li class="nail-color" value="그레이"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/gray.jpg" class="w3-circle" width="30" height="30">
									</div>그레이
							</a></li>
							<li class="nail-color" value="블랙"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/black.jpg" class="w3-circle" width="30" height="30">
									</div>블랙
							</a></li>
							<li class="nail-color" value="베이지"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/beige.png" class="w3-circle" width="30" height="30">
									</div>베이지
							</a></li>
							<li class="nail-color" value="믹스"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/mix.jpg" class="w3-circle" width="30" height="30">
									</div>믹스
							</a></li>
							<li class="nail-color" value="골드"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/gold.png" class="w3-circle" width="30" height="30">
									</div>골드
							</a></li>
							<li class="nail-color" value="실버"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/silver.jpg" class="w3-circle" width="30" height="30">
									</div>실버
							</a></li>
						</ul>
					</div>
				...
				<div class="w3-dropdown-hover">
					<div id="main-check" class="w3-border w3-hover-border-pale-red w3-round" style="padding-left: 10px;" value="네일/패디">
						<img src="${path }/resources/images/nails/nail-polish.png" class="w3-circle" width="20" height="20">
					...
					<div class="w3-dropdown-content w3-bar-block w3-card-4 w3-border w3-round" style="z-index: 999">
						<div class="nail-check" style="text-align: left; padding-left: 10px;" value="네일">
							<img src="${path }/resources/images/nails/beauty.png" class="w3-circle" width="20" height="20">
						...
						<div class="nail-check" style="text-align: left; padding-left: 10px;" value="페디">
							<img src="${path }/resources/images/nails/footprint.png" class="w3-circle" width="20" height="20">
				...
				<div class="w3-dropdown-hover">
					<div id="main-nail-style" class="w3-border w3-hover-border-pale-red w3-round" style="padding-left: 10px;" value="전체옵션">
						<img src="${path }/resources/images/nails/plus_btn.png" width="20" height="20">
					...
					<div id="" class="w3-dropdown-content w3-card-12 w3-border w3-round" style="z-index: 999">
						...
						<ul id="dropdown-menu">
							<li class="nail-style" value="프렌치" style="padding-left: 10px;"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/french.jpg" class="w3-circle" width="30" height="30">
									</div>프렌치
								</a></li>
							<li class="nail-style" value="아트"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/art.jpg" class="w3-circle" width="30" height="30">
									</div>아트
							</a></li>
							<li class="nail-style" value="파츠"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/parts.JPG" class="w3-circle" width="30" height="30">
									</div>파츠
							</a></li>
							<li class="nail-style" value="글리터"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/gliter.jpg" class="w3-circle" width="30" height="30">
									</div>글리터
							</a></li>
							<li class="nail-style" value="그라데이션"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/gradient.jpg" class="w3-circle" width="30" height="30">
									</div>그라데이션
							</a></li>
							<li class="nail-style" value="풀컬러"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/fullcolor.jpg" class="w3-circle" width="30" height="30">
									</div>풀컬러
							</a></li>
							<li class="nail-style" value="캐릭터"><a>
									<div style="text-align: center">
										<img src="${path }/resources/images/indexImg/char.jpg" class="w3-circle" width="30" height="30">
									</div>캐릭터
							</a></li>
						</ul>
					</div>
									...
									if (data.bookmarkList != null) {
										for (var j = 0; j < data.bookmarkList.length; j++) {
											if (data.bookmarkList[j].member_pk == "${memberLoggedIn.memberPk}" && data.bookmarkList[j].nail_pk == data.list[i].NAIL_PK) {
												mark_check = true;
												html2 += "<img src='${path }/resources/icons/love_filled.svg' class='b_icon zindex' id='b_icon'>";
												html2 += "<input class='bookmark_pk' name='bookmark_pk' type='hidden' value='"+data.bookmarkList[j].bookmark_pk+"'>";
											}
										}
									}
									if (!mark_check) {
										html2 += "<img src='${path }/resources/icons/love_blank.svg' class='b_icon zindex' id='b_icon'>";
			...
			<div id="nail-list">
				<c:forEach items="${nailist}" var="nail" varStatus="status">
					<div class="cover-card col-sm-${col_i[status.index]}">
						<!-- 여기서 onload 됬을떄 alt값을 check해서 정해줘야한다. -->

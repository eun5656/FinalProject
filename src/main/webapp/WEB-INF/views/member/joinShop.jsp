                ...
                <div class="col-md-12">
                    ...
                    제3조 (약관 등의 명시와 설명 및 개정) 
                      ...
                      ⑥ 이 약관에서 정하지 아니한 사항과 이 약관의 해석에 관하여는 전자상거래 등에서의 소비자보호에 관한 법률, 약관의 규제 등에 관한 법률, 공정거래위원회가 정하는 전자상거래 등에서의 소비자 보호지침 및 관계법령 또는 상관례에 따릅니다.
                                            ...
                                            <br>
                                            <h4 class="text-right">위 약관에 동의 합니다. <input type="checkbox" name='check1'  onclick="check_del()"></h4>
                                            ...
                                            <br>
                                            <h4 class="text-right">위 약관에 동의 합니다.(선택) <input type="checkbox" name='check1' onclick="check_del()"></h4>
                                            <hr>
            ...
            <div class="row setup-content" id="step-3">
              <div class="col-xs-12">
                <div class="col-md-12">
                  ...
                  <br>
              <div class="form-group">
                      <label class="col-sm-3 control-label" for="inputShopName">상호명</label>
                    <div class="col-sm-6">
                      <input class="form-control" id="inputShopName" type="text" placeholder="상호명">
                    </div>
                    </div>
                   
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="inputShopNumber">사업자번호</label>
                      <div class="col-sm-6">
                        <input class="form-control" id="inputShopNumber" type="text" placeholder="사업자번호">
                      </div>
                    </div>
            
                  
                    <div class="form-group">
                                <label class="col-sm-3 control-label" for="inputNumber">샵 전화  번호</label>
                              <div class="col-sm-6">
                                <input class="form-control" id="inputNumber" type="text" placeholder="이메일">
                              </div>
                              </div>
                    
                              <div class="form-group">
                                  <label class="col-sm-3 control-label" for="post">샵 상세 주소</label>
                                  <div class="col-sm-3">
                                    <input type="text" class="form-control" id="post" placeholder="우편번호" required>
                                  </div>
                                  <div class="col-sm-3">

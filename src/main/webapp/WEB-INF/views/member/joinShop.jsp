			...
			<div class="col-xs-12">
				<div class="col-md-12">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" id="memberPw_2" name="memberPw_2" type="password" placeholder="비밀번호 확인" required oninput="fn_pwCheck2();">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" id="inputName" type="text" placeholder="이름" name="memberName">
							<input class="form-control" id="inputLevel" type="hidden" name="memberLevel" value='2' />
						</div>
					</div>
					<div class="form-group">

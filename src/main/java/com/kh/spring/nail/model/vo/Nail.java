...
public class Nail implements Serializable {
	...
	public Nail(int nail_pk, String nail_name, String nail_color, String nail_check, String nail_style, int shop_pk,
			String nail_ori_img, String nail_re_img) {
		super();
	...
	public String toString() {
		return "Nail [nail_pk=" + nail_pk + ", nail_name=" + nail_name + ", nail_color=" + nail_color + ", nail_check="
				+ nail_check + ", nail_style=" + nail_style + ", shop_pk=" + shop_pk + ", nail_ori_img=" + nail_ori_img
				+ ", nail_re_img=" + nail_re_img + "]";
	}

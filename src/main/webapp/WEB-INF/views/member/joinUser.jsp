...
<jsp:include page="/WEB-INF/views/common/header.jsp">
	<jsp:param value="회원가입일반" name="pageTitle" />
</jsp:include>
		...
		<div class="row setup-content" id="step-2">
			<div class="col-xs-12">
				<div class="col-md-12">
					...
					<br>
					<div class="form-group">
						<label class="col-sm-3 control-label" for="member_id">아이디</label>
						<div class="col-sm-6">
							<input class="form-control" id="member_id" name="member_id" type="text" placeholder="아이디는 영문,숫자조합의 6~12자리의 조합(특수문자제외)" required>
							<p id="idCheck"></p>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label" for="member_pw">비밀번호</label>
						<div class="col-sm-6">
							<input class="form-control" id="member_pw" name="member_pw" type="password" placeholder="공백없이  영문, 숫자, 특수문자를 조합한 8~15자리의 비밀번호" required onblur="chkPwd();">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" id="member_pw2" name="member_pw2" type="password" placeholder="비밀번호 확인" required oninput="fn_pwCheck2();">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input class="form-control" id="member_name" type="text" placeholder="이름" name="member_name"/>
							<input class="form-control" id="member_leve" type="hidden" name="member_level" value='3' />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-3 control-label" for="member_phone">휴대폰</label>
						<div class="col-sm-6">
							<input class="form-control" name="member_phone" id="member_phone" type="text" placeholder="010-1234-5678" maxlength="15">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="member_address" name="member_address" placeholder="도로명 주소" required>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label" for="inputEmail">이메일</label>
               			<div class="col-sm-6">
               				<input id="JHCheck" type="email" class="form-control" name="member_email" placeholder="abc@efg.com" required>
...
<script>
	$("#JHCheck").blur(function() {
 	...
 	function emailRequest() {
 		...
 		var url="${pageContext.request.contextPath }/member/emailEnd.do?member_email="+nowemail;

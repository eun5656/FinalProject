				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<form class="navbar-form navbar-left" action="${path }/shop/searchLocation.do" method="post">
						<div class="input-group col-md-12">
							...
							<span class="input-group-btn"><button class="btn btn-danger input-sm" type="submit"><span class=" glyphicon glyphicon-search"></span></button></span>
						</div>
					</form>
					<ul class="nav navbar-nav navbar-right">
						<c:if test="${memberLoggedIn!=null }">
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-envelope-o">
								<span class="badge badge-danger">${count}</span></i>Messages<span class="caret"></span>
								</a>
								<ul class="dropdown-menu" style="border-radius: 3px; border-color: white">
